...
// validator.add_update_product = { // "body" for post,put body parameters
//     body: {
...
validator.productType_delete = { // "body" for post,put body parameters
    query: { //use query for querystring as well as for path params
        id: joi.string().required()
    },
    headers: authHeaderObj
};
validator.update_productType_status = { // "body" for post,put body parameters
    body: { //use query for querystring as well as for path params
        id: joi.string().required(),
